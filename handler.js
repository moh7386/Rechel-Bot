...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*[ ⚠️ تنبيه ⚠️ ] الأمر فقط للمطور*',
        owner: '*[ ⚠️ تنبيه ⚠️ ] الأمر فقط للمطور*',
        mods: '*[ ⚠️ تنبيه ⚠️ ] الأمر فقط للمطور*',
        premium: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙿𝙾𝚁 𝚄𝚂𝚄𝙰𝚁𝙸𝙾𝚂 𝙿𝚁𝙴𝙼𝙸𝚄𝙼 𝚈 𝙴𝙻/𝙻𝙰 𝙿𝚁𝙾𝙿𝙸𝙴𝚃𝙰𝚁𝙸𝙾/𝙰 (𝙾𝚆𝙽𝙴𝚁) 𝙳𝙴𝙻 𝙱𝙾𝚃*',
        group: '*[ ⚠️ تنبيه ⚠️ ] الأمر فقط للقروبات*',
        private: '*[ ⚠️ تنبيه ⚠️ ] الأمر فقط للخاص*',
        admin: '*[ ⚠️ تنبيه ⚠️ ] الأمر فقط للمشرفين*',
        botAdmin: '*[ ⚠️ تنبيه ⚠️ ] يجب أن اكون مشرف*',
