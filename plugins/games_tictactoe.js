...
export async function before(m) {
    ...
    if (room) {
        ...
        let str = `
${isWin ? `@${winner.split('@')[0]} Eres el ganador 🎉 *+${winScore} XP*` : isTie ? `Se acabó el juego, con un empate *+${playScore} XP*` : `الدور عليك ${['❎', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`} 
...
أكتب *.surrender* للانسحاب من اللعبة 
`.trim()
